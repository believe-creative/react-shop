              ...
              <div>
                ...
                <div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="email" value={this.state.email} placeholder="Enter email" name="email" onChange={this.change.bind(this)}/>
                  </div>
                  <div class="form-group">
                    <label for="pwd">Password:</label>
                    <input type="password" class="form-control" id="pwd" value={this.state.pwd} placeholder="Enter password" name="pwd" onChange={this.change.bind(this)}/>
                  </div>
                  <button type="button" class="btn btn-default" onClick={this.login.bind(this)}>Submit</button>
                </div>
              </div>
